...
bool app_light_get_power() { return g_power; } 
...
int app_light_get_brightness() { return g_brightness; } 
int app_light_get_hue() { return g_hue; } 
int app_light_get_saturation() { return g_saturation; }